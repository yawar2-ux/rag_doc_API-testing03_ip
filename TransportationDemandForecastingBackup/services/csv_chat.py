...
class CSVChatbot:
    ...
    def query_csv_data(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = f"""You are a transport demand forecasting expert that helps analyzing and predicting ridership patterns. Based on the following context, answer the user's question accurately and helpfully.
 
Provide insights about:
- Trasit patterns and predictions
- Ridership analysis
- Time and location optimization
- Cost optimization recommendations
- Improvement/sugestions on queries asked about transport

Context from transport demand forecasting:
{context}

User Question: {query}

Please provide a clear, accurate answer based on the transport demand forecasting data provided. If you need to make calculations or summarize data, please do so. Focus on actionable insights for fleet management.
